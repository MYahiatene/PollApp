            ...
            <v-content>
                <v-row>
                    <v-col cols="8">
                        ...
                        <v-list v-for="(question, index) in computedQuestionList" :key="question.questionId" two-line>
                            ...
                            <v-card class="mx-auto">
                                ...
                                <div v-else-if="question.questionType === 'ChoiceQuestion'">
                                    <v-list v-for="answer in question.answerPossibilities" :key="answer.text" dense>
                                        <v-checkbox
                                            class="pl-9"
                                            :label="answer"
                                            :color="fontColor"

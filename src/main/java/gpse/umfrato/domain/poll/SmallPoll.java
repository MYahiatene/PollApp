...
public class SmallPoll {
    ...
    public SmallPoll(final Poll original, final PollResultService pollResultService,
        ...
        this.activatedDate = original.isActivated() || original.getPollStatus() > 1 ? df.format(original.getActivatedDate()) : DEFAULT;
        this.deactivatedDate = original.isDeactivated() || original.getPollStatus() > 2 ? df.format(original.getDeactivatedDate()) : DEFAULT;

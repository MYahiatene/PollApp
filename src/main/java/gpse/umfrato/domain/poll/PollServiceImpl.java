...
class PollServiceImpl implements PollService {
     ...
     */
    @Autowired public PollServiceImpl(final PollRepository pollRepository, final CategoryService categoryService, final CategoryRepository categoryRepository) {
     ...
     */
    @Override @Transactional public Poll createPoll(final Poll poll) {
     ...
     * @return new poll
     */
    @Override @Transactional public Poll createCopyPoll(final Poll poll) {
        pollRepository.save(poll);
        return poll;
    }

    @Override @Transactional public Poll createSeriesPoll(final Poll poll) {
     ...
     */
    @Override public List<Poll> getAllPolls() {
     ...
     */
    @Override public String createAnonymousUsername() {
     ...
     */
    @Override public Integer activatePoll(final Long pollId) {
     ...
     * @return returns the poll activation status
     */
    @Override public Integer deactivatePoll(final Long pollId) {
        final Poll poll = pollRepository.getOne(pollId);
     ...
     */
    @Override public void editPollName(final Long pollId, final String pollName) {
        final Poll poll = pollRepository.getOne(pollId);
     ...
     */
    @Override public String deletePoll(final String pollID) {

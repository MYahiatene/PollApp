...
public class ExportServiceImpl implements ExportService {
    ...
    /**
     * @param input Die Funktion geht die Liste an gegebenen Antworten in einer Antwort durch und macht Listen CSV-Verträglich
     */
    ...
    /**
     * @param answer Die gegebene Antwort für die die Antwortliste durch die mögliche Antwort aus der Frage
     ...
     *             Die Funktion nimmt eine JSON entgegen und generiert daraus eine Liste an PollResults, die Funktion wird im
     *             Moment nicht genutzt aber vielleicht wird sie mal nütylich
     */
    @Override
     ...
     *               Die Funktion nimmt eine Poll und eine Liste an PollResults entgegen und generiert daraus eine "kombinierte"
     *               liste an beidem
     */
    @Override

...
public class ExportController {
    ...
    public Poll fromJSONToPoll(final @RequestBody String file) {
        final Poll poll = exportService.fromJSONToPoll(file);
        poll.setPollId(null);
